      ...
      <div className="relative" style={{ width: layout.canvasWidth, height: layout.canvasHeight }}>
        ...
        {active && effectiveViewport._tag !== "fill" ? (
          <>
            ...
            {activeDrag ? (
              <div
                className="pointer-events-none absolute z-40 -translate-x-1/2 rounded-md border border-border/80 bg-background/95 px-2 py-1 text-[0.6875rem] font-medium tabular-nums text-foreground shadow-md backdrop-blur-sm"
                style={{
