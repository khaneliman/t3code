  ...
  return (
    ...
    >
      {Icon ? (
        ...
        <span className={cn("text-[0.625rem] font-semibold leading-none", props.iconClassName)}>
      ...
      {props.showBadge ? (
        <span
          className={cn(
            "pointer-events-none absolute right-0 bottom-0 z-10 flex h-3.5 min-w-3.5 items-center justify-center rounded-full border px-0.5 text-[0.5rem] font-semibold leading-none shadow-sm",
            props.accentColor
