        ...
        <div className="p-3 space-y-4">
          ...
          {activePlan && activePlan.steps.length > 0 ? (
            <div className="space-y-1">
              <p className="mb-2 text-[0.625rem] font-semibold tracking-widest text-muted-foreground/40 uppercase">
                Steps
              </p>
          ...
          {planMarkdown ? (
            <div className="space-y-2">
              ...
              >
                ...
                <span className="text-[0.625rem] font-semibold tracking-widest text-muted-foreground/40 uppercase group-hover:text-muted-foreground/60">
                  {planTitle ?? "Full Plan"}
                </span>
              </button>
              {proposedPlanExpanded ? (
          ...
          {!activePlan && !planMarkdown ? (
            <div className="flex flex-col items-center justify-center py-12 text-center">
              <p className="text-[0.8125rem] text-muted-foreground/40">No active plan yet.</p>
              <p className="mt-1 text-[0.6875rem] text-muted-foreground/30">
