  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        aria-label="Search keybindings"
        className="h-6 w-44 rounded-md border border-input bg-background pl-7 pr-2 text-[0.6875rem] text-foreground outline-none placeholder:text-muted-foreground/72 focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/24"
      />
    </div>
  );
}
    ...
    return (
      <div className="flex items-center gap-2 rounded-md border border-border/70 bg-background/60 px-2 py-2">
        <Toggle
          ...
          variant="outline"
          size="xs"
          className="h-7 min-w-10 px-2 text-[0.6875rem] sm:h-7"
        >
          Not
        </Toggle>
        <WhenVariableSelect
      ...
      <div className="flex min-w-0 items-center gap-2 pr-4">
        {showPill ? (
          ...
          >
            ...
            <span className="text-[0.625rem] uppercase tracking-[0.08em] text-muted-foreground/0 transition-opacity group-hover:text-muted-foreground/70 group-focus-visible:text-muted-foreground/70">
              Edit
            </span>
          </button>
        ) : (
  ...
  return (
    <SettingsPageContainer className="max-w-5xl">
      ...
      >
        ...
        >
          <div className="grid min-w-[680px] grid-cols-[minmax(190px,1.1fr)_minmax(220px,0.85fr)_minmax(210px,1fr)_60px] border-b border-border/70 bg-muted/25 px-4 py-2 text-[0.6875rem] font-semibold uppercase tracking-[0.07em] text-muted-foreground">
            <div>Command</div>
            <div>Keybinding</div>
            <div>When</div>
            <div>Status</div>
